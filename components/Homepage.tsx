               ...
               {apiData.map((item: any, index: number) => (
                    <div key={index} className="bg-white p-3 mb-3 w-[310px] mr-4 rounded-xl">
                              ...
                              <div className="flex items-center">
                                 ...
                                 <img
                                   ...
                                   <div>
                                        ...
                                        <h6 className="ml-2 text-gray-500 text-[14px]">{item.employer_name.length > 12 ? item.employer_name.slice(0, 12) + "..." : item.employer_name}</h6>
                                   </div>
                              </div>
                         ...
                         <ul className="flex mt-2">
                              <li className="bg-gray-100 p-[6px] rounded-lg text-[12px] font-semibold mr-1 text-gray-500">{item.job_employment_type}</li>
                              <li className="bg-gray-100 p-[6px] rounded-lg mr-1 text-[12px] font-semibold text-gray-500">Expert</li>
                              <li className="bg-gray-100 p-[6px] rounded-lg text-[12px] font-semibold mr-1 text-gray-500">Remote</li>
                         </ul>
                         <div className="flex justify-between items-center mt-3">
                              ...
                              <span className="text-[14px] text-gray-400">{formatDate(item.job_posted_at_datetime_utc)}</span>
                         </div>
                    </div>
               ))}
          </div>
